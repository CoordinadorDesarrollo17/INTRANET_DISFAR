        ...
        public Helper_E InsertarTransaccionIngresoKardex(string itemCode, string itemName, int cantidadGlobal, string operarioRegistra, int docNumSolicitudTraslado, string cardCode, string cardName, SqlConnection cn)
        {
            ...
            try
            {
                ...
                using (SqlCommand cmd = new SqlCommand("sp_MantenimientoKardexAbastecimiento ", cn))
                {
                    ...
                    cmd.Parameters.AddWithValue("@Referencia", docNumSolicitudTraslado);

                    // Parámetros extraidos del detalle
                    cmd.Parameters.AddWithValue("@ItemCode", itemCode);
                    cmd.Parameters.AddWithValue("@ItemName", itemName);
                    cmd.Parameters.AddWithValue("@Almacen", "RESERVA");
                    cmd.Parameters.AddWithValue("@Cantidad", cantidadGlobal);
                    ...
                    if (idGenerado <= 0)
                    {
                        ...
                        icono = "error";
                        throw new Exception("Error en InsertarTransaccionIngresoKardex");
                    }
                }
