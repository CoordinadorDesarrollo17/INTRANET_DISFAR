...
namespace Capa_Usuario.Controllers
{
    public class RecursosHumanosController : Controller
    {
        ...
        public JsonResult EditarEmpleado(OEMPL_E form, EMPL1_E form2, int idOperation = 4101)
        {
            ...
            if (form == null || form2 == null || form2.Id <= 0)
            {
        ...
        public ActionResult ExportarListadoNumerosCorporativos(RptNumerosCorporativos_E filtro, int idOperation = 4000)
        {
            ...
            {
                int columnas = 11;
                var listado = new Capa_Negocio.RecursosHumanos_NEG.TablasSQL.ONUM_N().ExportarListaNumeros(filtro);
        ...
        private string VerificarAccesos(int idOperation)
        {
            ...
            return helper.VerificarAccesos(idOperation, usu, nombreOperacion, modulo, userHostAddress, userHostName);
        }
    }
}